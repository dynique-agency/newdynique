...
const data: CityData = {
  ...
  highlights: [
    ...
    { n: "04", title: "Cross-border Business", desc: "Voor erfgoed-, horeca- en retailondernemers die met een Nederlandse partij willen samenwerken: heldere afspraken over btw-verlegging en facturatie, geen verrassingen achteraf." },
  ],
  ...
  faq: [
    ...
    { q: "Hoe zit het met facturatie tussen Nederland en België?", a: "Voor Tongerse ondernemers in erfgoed, horeca of retail die met een Nederlandse partij samenwerken, werken we met btw-verlegging (intracommunautaire dienst): standaard binnen de EU, en we regelen dat administratief correct van begin af aan — zodat jij je kunt richten op je bezoekers, niet op de aangifte." },
